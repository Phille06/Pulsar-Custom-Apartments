...
exports("StartRaid", function(source, apartmentId, characterSID)
	...
	if not apartmentId or not characterSID or GetCharacterApartment(characterSID) ~= apartmentId then
		return false
	end
