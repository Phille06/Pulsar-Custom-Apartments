...
Config.ReceptionPed = {
    ...
    coords = vector4(-461.8189, -914.9046, 27.1006, 87.8875), -- Location near apartment entrance (x, y, z, heading)
    ...
    ["nexus_apartment_block_2"] = {
        [0] = { -- GROUND FLOOR (Lobby)
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-478.5, -1039.82, 24.31),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [1] = { -- 1st Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.76, -1048.56, 43.82),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [2] = { -- 2nd Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.8, -1048.55, 54.82),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [3] = { -- 3rd Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.86, -1048.59, 65.82),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [4] = { -- 4th Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.81, -1048.52, 76.82),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [5] = { -- 5th Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.9, -1048.65, 87.82),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [6] = { -- 6th Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.84, -1048.63, 98.82),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
        ...
        [7] = { -- 7th Floor
            ...
            [1] = {
                ...
                poly = {
                    center = vector3(-487.82, -1048.54, 104.3),
                    length = 2.0,
                    width = 2.0,
                    options = {
                        heading = 0,
